...
export class WasmTimeSlices {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmTimeSlicesFinalization.unregister(this);
        return ptr;
    }
     ...
     */
    get_times() {
        const ret = wasm.wasmtimeslices_get_times(this.__wbg_ptr);
...
const WasmTimelineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class WasmTimeline {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WasmTimelineFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmtimeline_free(ptr, 0);
    }
    /**
     * @param {string} who
     * @returns {any}
    ...
    get_balances(who) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmtimeline_get_balances(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @param {string} who
    ...
    get_limb_state(who) {
        const ptr0 = passStringToWasm0(who, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmtimeline_get_limb_state(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @param {string} who
    ...
    get_afflictions(who) {
        const ptr0 = passStringToWasm0(who, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmtimeline_get_afflictions(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @returns {number}
