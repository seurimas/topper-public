...
targetted_action!(Cripple, "kai cripple {}");
targetted_action!(Strike, "kai strike {}");
untargetted_action!(Heal, "kai heal");
targetted_action!(Banish, "kai banish {}");
targetted_action!(Enfeeble, "kai enfeeble {}");
