...
pub const WHIRLWIND_DAMAGE: CType = 900;
pub const WRENCH_DAMAGE: CType = 1400;
pub const JAB_DAMAGE: CType = 500;
pub const HOOK_DAMAGE: CType = 550;
pub const UPPERCUT_DAMAGE: CType = 550;
